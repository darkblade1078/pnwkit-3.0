...
[pnwkit 3.0](../../modules.md) / api/queries/cities
...
Defined in: [api/queries/cities.ts:47](https://github.com/darkblade1078/pnwkit-3.0/blob/90a5a52aed3afbb66ab886d65370a1461d0b47a4/src/api/queries/cities.ts#L47)
...
Defined in: [api/queries/cities.ts:53](https://github.com/darkblade1078/pnwkit-3.0/blob/90a5a52aed3afbb66ab886d65370a1461d0b47a4/src/api/queries/cities.ts#L53)
...
Defined in: [api/queries/cities.ts:108](https://github.com/darkblade1078/pnwkit-3.0/blob/90a5a52aed3afbb66ab886d65370a1461d0b47a4/src/api/queries/cities.ts#L108)
...
Defined in: [api/queries/cities.ts:109](https://github.com/darkblade1078/pnwkit-3.0/blob/90a5a52aed3afbb66ab886d65370a1461d0b47a4/src/api/queries/cities.ts#L109)
...
> **include**\<`K`, `TConfig`, `TNestedResult`, `TWrappedResult`\>(`relation`, `config`): [`CitiesQuery`](#citiesquery)\<`F`, `I` & `Record`\<`K`, `TWrappedResult`\>\>

Defined in: [api/queries/cities.ts:94](https://github.com/darkblade1078/pnwkit-3.0/blob/90a5a52aed3afbb66ab886d65370a1461d0b47a4/src/api/queries/cities.ts#L94)
...
[`CitiesQuery`](#citiesquery)\<`F`, `I` & `Record`\<`K`, `TWrappedResult`\>\>
...
> **select**\<`Fields`\>(...`fields`): [`CitiesQuery`](#citiesquery)\<`Fields`\>

Defined in: [api/queries/cities.ts:72](https://github.com/darkblade1078/pnwkit-3.0/blob/90a5a52aed3afbb66ab886d65370a1461d0b47a4/src/api/queries/cities.ts#L72)
...
[`CitiesQuery`](#citiesquery)\<`Fields`\>
...
Defined in: [api/queries/cities.ts:88](https://github.com/darkblade1078/pnwkit-3.0/blob/90a5a52aed3afbb66ab886d65370a1461d0b47a4/src/api/queries/cities.ts#L88)
