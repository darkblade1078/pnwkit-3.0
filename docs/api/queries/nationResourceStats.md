...
[pnwkit 3.0](../../modules.md) / api/queries/nationResourceStats

# api/queries/nationResourceStats
...
Defined in: [api/queries/nationResourceStats.ts:62](https://github.com/darkblade1078/pnwkit-3.0/blob/7be0cfb947feae03d5bb93d0b330b9e11d4123aa/src/api/queries/nationResourceStats.ts#L62)
...
Defined in: [api/queries/nationResourceStats.ts:68](https://github.com/darkblade1078/pnwkit-3.0/blob/7be0cfb947feae03d5bb93d0b330b9e11d4123aa/src/api/queries/nationResourceStats.ts#L68)
...
Defined in: [api/queries/nationResourceStats.ts:192](https://github.com/darkblade1078/pnwkit-3.0/blob/7be0cfb947feae03d5bb93d0b330b9e11d4123aa/src/api/queries/nationResourceStats.ts#L192)
...
Defined in: [api/queries/nationResourceStats.ts:193](https://github.com/darkblade1078/pnwkit-3.0/blob/7be0cfb947feae03d5bb93d0b330b9e11d4123aa/src/api/queries/nationResourceStats.ts#L193)
...
> **include**\<`K`, `TConfig`, `TNestedResult`, `TWrappedResult`\>(`relation`, `config`): [`NationResourceStatsQuery`](#nationresourcestatsquery)\<`F`, `I` & `Record`\<`K`, `TWrappedResult`\>\>

Defined in: [api/queries/nationResourceStats.ts:149](https://github.com/darkblade1078/pnwkit-3.0/blob/7be0cfb947feae03d5bb93d0b330b9e11d4123aa/src/api/queries/nationResourceStats.ts#L149)
...
[`NationResourceStatsQuery`](#nationresourcestatsquery)\<`F`, `I` & `Record`\<`K`, `TWrappedResult`\>\>
...
> **select**\<`Fields`\>(...`fields`): [`NationResourceStatsQuery`](#nationresourcestatsquery)\<`Fields`\>

Defined in: [api/queries/nationResourceStats.ts:89](https://github.com/darkblade1078/pnwkit-3.0/blob/7be0cfb947feae03d5bb93d0b330b9e11d4123aa/src/api/queries/nationResourceStats.ts#L89)
...
[`NationResourceStatsQuery`](#nationresourcestatsquery)\<`Fields`\>
...
Defined in: [api/queries/nationResourceStats.ts:114](https://github.com/darkblade1078/pnwkit-3.0/blob/7be0cfb947feae03d5bb93d0b330b9e11d4123aa/src/api/queries/nationResourceStats.ts#L114)
